...
- **Consecuencias:**
  - `requirements.txt`: `argostranslate==1.11.0`; `ARGOS_COMPUTE_TYPE=default` es **obligatorio** (sin él, argos es→en produce basura — bug documentado con test y guard en el harness del ADR-014).
