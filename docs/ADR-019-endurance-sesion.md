...
**Medición del camino declarado** (misma máquina, párrafo real del video, n=2; GPU libre): latentes **747–807 ms** (una vez por perfil, fuera del presupuesto por turno — coincide con los 756 ms del ADR-014), **primer chunk 1.98–2.00 s** (primera frase completa) y cómputo total **16.98–17.27 s** para 17–23 s de audio → **RTF sostenido 0.76–0.98** (< 1 en ambas corridas).
